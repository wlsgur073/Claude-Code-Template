...
- **Next step line**: One line inside the Top 3 block suggesting which follow-up skill to run:
  ...
  - Score is 100/100: omit the Priority list. Show "Your configuration is in great shape. No changes needed." and suggest exploring advanced features the project doesn't yet use (e.g., "Consider adding specialized agents for code review vs implementation tasks").
