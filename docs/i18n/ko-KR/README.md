...
<p align="center">
  <a href="../../../README.md">English</a> | <b>한국어</b> | <a href="../ja-JP/README.md">日本語 (WIP — README 전용)</a>
</p>
...
> **Windows**에서는 SessionStart 훅이 이제 bash 엔트리와 PowerShell 엔트리를 함께 제공하므로, **PowerShell 5.1+ (Windows 10+ 기본 탑재) 또는 Git Bash/WSL** 중 하나만 있으면 훅이 정상 동작합니다. **고급 템플릿 스크립트(`templates/advanced/scripts/*.sh`)는 여전히 bash 호환 쉘이 필요합니다.**
